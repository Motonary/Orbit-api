  ...
  renderProjectList() {
    return(
      _.map(this.props.revolvingProjects, (project, key) => {
        return(
          <li key={key} className="revolving-project" onClick={this.onClickFixedStarOnBar.bind(this, project.id)}>
...
export default connect(({revolvingProjects, revolvingAssignments}) => ({revolvingProjects, revolvingAssignments}),
